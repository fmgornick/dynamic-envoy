...
type Cluster struct {
	Endpoints []string // different domains the cluster could route to
...
type Endpoint struct {
	...
	Name        string // specific endpoint name from cluster name
...
func (cfg *Config) AddEndpoint(address string, clusterName string, name string, port uint, region string, weight uint) {
